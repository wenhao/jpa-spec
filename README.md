...
[![Quality Gate Status](https://sonarcloud.io/api/project_badges/measure?project=wenhao_jpa-spec&metric=alert_status)](https://sonarcloud.io/dashboard?id=wenhao_jpa-spec)
